...
const Progress = () => {
  ...
  if (!progress) return <div className='px-6 pt-16 text-muted'>Loading progress…</div>
  ...
  return (
    <div className='px-5 pt-10'>
      <p className='font-display text-2xl text-ink mb-1'>Your progress</p>
      <p className='text-muted mb-6'>keep the streak alive</p>
      ...
      <div className='bg-bg-card border border-hairline rounded-2xl p-5 mb-6 flex items-center gap-4'>
        ...
        <div>
          <p className='text-ink font-medium'>day streak</p>
          <p className='text-muted text-sm'>consecutive completed days</p>
        </div>
      </div>
      ...
      <div className='bg-bg-card border border-hairline rounded-2xl p-5 mb-6'>
        <p className='text-ink font-medium mb-4'>Accuracy by skill</p>
        <SkillBar label='vocabulary' value={progress.accuracy.vocab} />
        <SkillBar label='grammar' value={progress.accuracy.grammar} />
        <SkillBar label='reading' value={progress.accuracy.reading} />
      </div>

      <div className='bg-bg-card border border-hairline rounded-2xl p-5'>
        <p className='text-ink font-medium mb-4'>Day-by-day breakdown</p>
        <div className='overflow-x-auto'>
          <table className='w-full text-sm min-w-[420px]'>
            <thead>
              <tr className='text-left text-muted border-b border-hairline'>
                <th className='py-2 pr-3 font-medium'>Day</th>
                <th className='py-2 px-3 font-medium'>Vocab</th>
                <th className='py-2 px-3 font-medium'>Grammar</th>
                <th className='py-2 px-3 font-medium'>Reading</th>
            ...
            <tbody>
              ...
              {progress.days.length === 0 && (
                <tr><td colSpan={5} className='py-6 text-center text-muted'>No homework activity yet.</td></tr>
              )}
            </tbody>
          </table>
        </div>
