...
// the Profile page's "Install app" button), not automatically. Firefox and iOS Safari never fire
// this event at all; iOS has no programmatic install and needs the manual Share -> Add to Home
// Screen flow instead, which the Profile page explains rather than trying to trigger.
