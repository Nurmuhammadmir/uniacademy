...
// lets the admin add this app to their phone/desktop home screen with one tap, instead of hunting
// through the browser menu themselves. Chrome/Edge/Android support a real native install prompt;
// iOS Safari has no such API at all, so it gets step-by-step Share -> Add to Home Screen
