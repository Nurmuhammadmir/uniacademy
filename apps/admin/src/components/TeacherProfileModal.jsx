      ...
      {!data ? (
        ...
        <div className='flex flex-col gap-5'>
          <div>
            ...
            <p className='text-muted text-xs mt-1'>working since {new Date(data.employedSince).toLocaleDateString()}</p>
          </div>
          ...
          <div>
            <p className='text-ink font-medium mb-2'>Groups</p>
            <div className='flex flex-col gap-1'>
              ...
              {data.groups.length === 0 && <p className='text-muted text-sm'>No groups yet.</p>}
            </div>
          </div>
        </div>
      )}
