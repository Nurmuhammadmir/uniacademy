...
const financialTransactionSchema = new mongoose.Schema({
  ...
  clientId: { type: mongoose.Schema.Types.ObjectId, ref: 'LamusClient', default: null },
  orderId: { type: mongoose.Schema.Types.ObjectId, ref: 'LamusOrder', default: null },
  createdBy: { type: mongoose.Schema.Types.ObjectId, ref: 'LamusUser', required: true },
}, { timestamps: true })

const financialTransactionModel = mongoose.models.LamusFinancialTransaction || mongoose.model('LamusFinancialTransaction', financialTransactionSchema)
