...
const orderSchema = new mongoose.Schema({
  ...
  bottlesGiven: { type: Number, required: true, default: 0, min: 0 },
  bottlesReturned: { type: Number, required: true, default: 0, min: 0 },
  netBottles: { type: Number, required: true, default: 0 },
  unitPrice: { type: Number, required: true, default: 0, min: 0 },
  saleAmount: { type: Number, required: true, default: 0, min: 0 },
